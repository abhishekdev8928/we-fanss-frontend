...
const Addsectionmaster = () => {
  ...
  const handleAddSubmit = async (e) => {
    ...
    try {
      ...
      const response = await addsectionmaster(payload);
      ...
      toast.success(response.message || "Section master added successfully");
      setErrors({});
                ...
                <form onSubmit={handleAddSubmit}>
                  ...
                  <div className="d-flex justify-content-between align-items-center mt-4 pt-3" style={{ borderTop: "1px solid #eee" }}>
                    ...
                    <Button color="primary" type="submit">
                      <i className="mdi mdi-plus-circle-outline me-1"></i>Add Section Master
                    </Button>
                  </div>
                </form>
              </CardBody>
