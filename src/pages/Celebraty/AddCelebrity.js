// AddCelebrityForm.jsx - COMPLETE Updated Version with All Fields
...
const AddCelebrityForm = () => {
  ...
  // ✅ Custom styles for react-select (lighter border)
  const customSelectStyles = {
    control: (base, state) => ({
      ...base,
      borderColor: state.isFocused ? "#86b7fe" : "#dee2e6", // ✅ Same as input border
  ...
  const validateForm = () => {
    ...
    if (!formData.primaryProfession) {
      ...
      newErrors.primaryProfession =
        "Primary profession must be from selected professions";
    }
    ...
    if (formData.primaryLanguage && formData.languages.length > 0) {
      if (!formData.languages.includes(formData.primaryLanguage)) {
        newErrors.primaryLanguage =
          "Primary language must be from selected languages";
      }
    }
    ...
    if (formData.careerStartYear && formData.careerEndYear) {
      if (
        !formData.isCareerOngoing &&
        parseInt(formData.careerEndYear) < parseInt(formData.careerStartYear)
      ) {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (formData.spouseName) {
        formDataToSend.append(
          "familyRelationships[spouse][name]",
      ...
      console.log("Submitting celebrity data...");
                      ...
                      <Row>
                          ...
                          <Select
                            ...
                            onChange={(selectedOptions) => {
                              ...
                              setFormData((prev) => ({
                                ...
                                primaryProfession: selected.includes(
                        ...
                        <Col md="6" className="mb-3">
                          ...
                          <Select
                            ...
                            isClearable
                            className={
                              errors.primaryProfession ? "is-invalid" : ""
                            }
                          />
                          ...
                          <Select
                            ...
                            onChange={(selectedOptions) => {
                              ...
                              setFormData((prev) => ({
                                ...prev,
                                languages: selected,
                                primaryLanguage: selected.includes(
                        ...
                        <Col md="6" className="mb-3">
                          ...
                          <div className="d-flex gap-2 align-items-center">
                            <Input
                              ...
                              className={
                                errors.careerEndYear ? "is-invalid" : ""
                              }
                            />
                            <div className="form-check">
                              <Input
                      ...
                      <Row>
                        ...
                        {isAdmin && (
                          <>
                            ...
                            {/* ✅ NEW: Keywords with Enter key input */}
                            <Col md="12" className="mb-3">
